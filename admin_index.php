  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Số tiền đơn hàng đang chờ xử lý</h5>
          <p class="card-text"> 
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượn sách có sẵn</h5>
          <p class="card-text">
          <?php echo $bookscount; ?>
          </p>
          <div class="buttons" style="display: flex;">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng thông báo</h5>
          <p class="card-text">
          <?php echo $msgcount; ?>
          </p>
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số tài khoản của Admins</h5>
          <p class="card-text">
