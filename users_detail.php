...
<body>
   ...
   ?>
   <div class="box">
       <div class="name">Mã Người dùng: <?php echo $fetch_user['Id']; ?></div>
      ...
      <div class="price"style="color:<?php if($fetch_user['user_type'] == 'Admin'){ echo 'red'; }else{ echo 'blue'; } ?>;">Loại người dùng: <?php echo $fetch_user['user_type']; ?></div>
      <a style="color:rgb(255, 187, 0);" href="users_detail.php?update_user=<?php echo $fetch_user['Id']; ?>">Cập nhật</a>
      <a href="users_detail.php?delete_user=<?php echo $fetch_user['Id']; ?>" onclick="return confirm('Xóa tài khoản này?');">Xóa</a>
   </div>
   <?php
      }
   }else{
