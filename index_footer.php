        ...
        <div class="sub_main">
            <div class="short_links flex" style="justify-content:center; ">
                    ...
                    <li>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                                <a href="index.php#Adventure">Phưu lưu</a>
                                <a href="index.php#Magical">Phép thuật</a>
                                <a href="index.php#Knowledge">Kiến thức</a>
                            </div>
                        </div>
                    </li>
                    <li><a href="about-us.php">Xem thêm</a></li>
                </ul>
                <?php
                ...
                <ul class="account">
                    ...
                    <li><a href="orders.php">Lịch sử đặt hàng</a></li>
