...
if(isset($_POST['update'])){
    ...
    $message[]=''.$user_name.' Giỏ của bạn đã được cập nhật thành công';
}
...
<body>
    ...
    ?>
        <table style="width: 70%; align-items:center; margin:10px auto;" >
            ...
            <tbody>
                ...
                $total += $sub_total;
                    ...
                    echo '<p class="empty">Chưa có gì trong giỏ !!!!!!!!</p>';
                }
                ?>
                <tr>
        ...
        <a href="checkout.php" class="btn cart-btn1" style="display:<?php if($total>1){ echo 'inline-block'; }else{ echo 'none'; };?>" > &nbsp; Thanh toán</a> <a class="cart-btn2" href="index.php">Tiếp tục mua hàng</a>
    </div>
