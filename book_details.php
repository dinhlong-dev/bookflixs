...
if (isset($_POST['add_to_cart'])) {
    ...
    if (mysqli_num_rows($select_book) > 0) {
        $message[] = 'Sách này đã có trong giỏ hàng của bạn';
    } else {
                    ...
                    <div class="row_box">
                        <form style="display: flex ;" action="" method="POST">
                            ...
                            <div class="col_box">
                                ...
                                <h3>Giá: <?php echo $fetch_book['price']; ?>đ</h3>
                                ...
                                <div class="buttons">
                                    ...
                                    <button name="add_to_cart" ><img style="height: 40px;" src="./images/cart1.png" alt="Thêm vào giỏ"></button>
                                </div>
                                <h3>Nội dung sách</h3>
