...
<body>
   ...
   ?>
   <div class="box">
       <div class="name">Mã thông báo: <?php echo $fetch_user['id']; ?></div>
      ...
      <div class="price">Thông báo: <?php echo wordwrap($fetch_user['msg'],30,"<br>\n",TRUE); ?></div>
      <div class="price">Ngày gửi: <?php echo $fetch_user['date']; ?></div>
      <a href="message_admin.php?delete_msg=<?php echo $fetch_user['id']; ?>" onclick="return confirm('Xóa tin nhắn này?');">Delete</a>
   </div>
   <?php
      }
   }else{
      echo '<p class="empty">Chưa nhận được thông báo!</p>';
   }
   ?>
    </div>
    </section>
