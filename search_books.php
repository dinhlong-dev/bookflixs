...
if (isset($_POST['add_to_cart'])) {
   ...
   if (mysqli_num_rows($select_book) > 0) {
       $message[] = 'Cuốn này đã có trong giở hàng của bạn';
   } else {
...
<body>
   ...
   <section class="search-form">
      ...
      <form action="" method="POST">
         <input type="text" class="box" name="search_box" placeholder="Tìm kiếm...">
   ...
   <div class="msg">
      ...
      if (isset($_POST['search_btn'])) {
         ...
         echo '<h4>Kết quả tìm kiếm của "'. $search_box.'":</h4>';
      };
      ?>
   </div>
                  ...
                  <div class="box" style="width: 255px;height: 342px;">
                     ...
                     <form action="" method="POST">
                        ...
                        <button onclick="myFunction()" name="add_to_cart"><img src="./images/cart2.png" alt="Add to cart">
                           <a href="book_details.php?details=<?php echo $fetch_book['bid'];
                                                               echo '-name=', $fetch_book['name']; ?>" id="adventure" class="update_btn">Xem thêm</a>
                     </form>
                  </div>
         <?php
               }
